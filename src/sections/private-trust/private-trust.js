      ...
      >
        ...
        >
          <Grid
            ...
            spacing={{ xs: 5, md: 0 }}
            sx={{ paddingBottom: 15, paddingTop: 15 }}
          >
            <Grid xs={12} md={6}>
              <Stack
                sx={{
              ...
              >
                ...
                <m.div variants={varFade().inDown}>
                  ...
                  >
                    ...
                    (Fiduciario), con el fin de que los controle y administre en beneficio de
                  ...
                  >
                    ...
                    la flexibilidad y confidencialidad son las principales ventajas que un trust
                    tiene sobre otras formas jurídicas para mantener, preservas y transferir la
                    riqueza. El concepto del trust ha demostrado ser sumamente flexible y es
                    ampliamente utilizado en la planificación financiera entre ellas:
                  </Typography>
                </m.div>
              </Stack>
            </Grid>
            ...
            <Grid xs={12} md={6} align="center">
              <m.div variants={varFade().inUp}>
                <Image
                  ...
                  src={`/assets/images/sections/private-trust/07_COLOR.png`}
                />
              </m.div>
            </Grid>
          </Grid>
            ...
            <Grid xs={12} md={6} align="center">
              <m.div variants={varFade().inUp}>
                <Image
                  ...
                  src={`/assets/images/sections/private-trust/08_COLOR.png`}
                />
              </m.div>
            </Grid>
              ...
              >
                ...
                <m.div variants={varFade().inUp}>
                  ...
                  >
                    ...
                    determinados activos, como una empresa o propiedad, dentro de una familia. Por
                    la adquisición del trust legal de los derechos de propiedad de los activos, las
                    personas relevantes pueden ser capaces de seguir beneficiándose de los activos,
                    evitando la fragmentación de la propiedad entre un gran número de beneficiarios
                    de una segunda y tercera generación. El uso del trust evita, que por la muerte
                    de un beneficiario, el riesgo que la propiedad de parte de los activos quede
                    fuera de la familia, y por lo tanto permite conservar intacto los beneficios de
            ...
            <Grid xs={12} md={6}>
              ...
              >
                ...
                <m.div variants={varFade().inUp}>
                  ...
                  >
                    El trust proporciona un vehículo eficiente para la transferencia de la
                    titularidad del patrimonio ante la muerte del settlor. La estructura del trust
                    puede servir para evitar impuestos a la herencia. Se puede utilizar también para
                    proteger a los beneficiarios más vulnerables.
                  </Typography>
                </m.div>
              </Stack>
            </Grid>
            ...
            <Grid xs={12} md={6} align="center">
              <m.div variants={varFade().inUp}>
                <Image
                  ...
                  alt="rocket"
                  sx={{ m: { xs: 3, md: 3 }, ml: { xs: 0, md: 5 } }}
                  src={`/assets/images/sections/private-trust/09_COLOR.png`}
                />
              </m.div>
            </Grid>
          </Grid>
            ...
            <Grid xs={12} md={6}>
              ...
              >
                ...
                <m.div variants={varFade().inUp}>
                  ...
                  >
                    Se usa para que el patrimonio familiar bajo el Trust quede protegido de
                    acreedores comerciales ya que están en un patrimonio independiente administrado
                    por el Fiduciario.
                  </Typography>
                </m.div>
              </Stack>
            ...
            <Grid xs={12} md={6}>
              ...
              >
                ...
                <m.div variants={varFade().inUp}>
                  ...
                  >
                    En muchas jurisdicciones el Trust es una entidad exenta de impuestos y en caso
                    de un Trust irrevocable se produce una enajenación del patrimonio extinguiendo
