          ...
          <div className="grid h-full items-center gap-4 lg:grid-cols-12">
            <div className="col-span-5 flex h-full flex-col items-center justify-center py-10 lg:items-start lg:py-20">
              ...
              <div className="flex space-x-4">
                ...
                {/* <Link href="/collection/explore_collection">
                  <a className="rounded-lg bg-white py-3 px-8 text-center font-semibold text-accent shadow-white-volume transition-all hover:bg-accent-dark hover:text-white hover:shadow-accent-volume">
                    Saber más
                  </a>
                </Link> */}
              </div>
            ...
            <div className="col-span-6">
              <div className="relative text-center lg:pl-32 lg:text-right">
                ...
                <img
                  src="https://img.freepik.com/fotos-premium/retrato-vertical-exitosa-mujer-negocios-que-usa-silla-ruedas-mientras-dirige-reunion-equipo-oficina_236854-36773.jpg"
