...
const ValueProposal = () => {
  const featuresContent = [
    ...
    },
    {
      ...
      text: `Somos sensibles a las necesidades de nuestros clientes y nos anticipamos a las necesidades de sus negocios mitigando los riesgos presentes y futuros. `,
    },
    {
      id: 3,
      icon: (
      ...
      text: `Al entender las razones de negocios detrás de cada asunto, somos capaces de aplicar un enfoque integral y proveer valor agregado a los mismos.`,
    },
  ];
  ...
  return (
    <>
      {/* <!-- Features --> */}
      <section className="relative pt-10 pb-24 dark:bg-jacarta-800">
